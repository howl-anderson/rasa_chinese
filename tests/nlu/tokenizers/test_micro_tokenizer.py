...
@pytest.mark.parametrize(
    ...
    [
        ...
        # currently, no english support yet
        # (
        #     "Micheal你好吗？",
        #     ["Micheal", "你好", "吗", "？"],
        #     [(0, 7), (7, 9), (9, 10), (10, 11)],
...
def test_microtokenizer(text, expected_tokens, expected_indices):
    tk = MicroTokenizer()
...
def test_microtokenizer_load_dictionary(tmp_path: Path):
    dictionary_path = str(tmp_path)

    component_config = {"dictionary_path": dictionary_path}

    with patch.object(
        MicroTokenizer, "load_custom_dictionary", return_value=None
    ) as mock_method:
        tk = MicroTokenizer(component_config)
